...
public sealed class ReviseCostCenterValidation
{
    public ValidationOutcome Check(ReviseCostCenter command)
    {
        var errors = new List<string>();
        if (string.IsNullOrWhiteSpace(command.CostCenterId)) errors.Add("A cost centre id is required.");
