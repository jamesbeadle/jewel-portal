...
public sealed class ReviseCostCenterAuthorisation
{
    ...
    public bool Allows(SignedInUser user, ReviseCostCenter command) => RolesThatMayManageCostCenters.IncludesAny(user.Roles);
}
