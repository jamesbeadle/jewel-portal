...
/// Public clients only: no secret is issued, and the flow is protected by PKCE + the user's own
/// portal sign-in on the consent page. Registration is deliberately open (the spec's model) —
/// a registered client grants nothing by itself; every token still requires a portal user to
/// sign in and approve.
/// </summary>
