...
internal static class FormLinkMapping
{
    public static FormInvite ToModel(this FormInviteEntity entity) => new(
        entity.FormInviteId, entity.FormPackId, entity.FormSlug, (JewelCompany)entity.Company, entity.PersonName,
    ...
    public static FormPack ToModel(this FormPackEntity entity, IEnumerable<FormInviteEntity> invites) => new(
        entity.FormPackId, (JewelCompany)entity.Company, entity.PersonName, entity.Email, (Engagement)entity.EngagedAs,
