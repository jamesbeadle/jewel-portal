...
// administrators, project managers, and the finance director. Administrators are granted every
// role server-side, so they pass this gate via Role.Admin. A dedicated triage-visibility role
// can be added later.
