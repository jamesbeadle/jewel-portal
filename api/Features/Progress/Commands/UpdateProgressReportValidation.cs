...
public sealed class UpdateProgressReportValidation
{
    public ValidationOutcome Check(UpdateProgressReport command)
    {
        var errors = new List<string>();
        if (string.IsNullOrWhiteSpace(command.ProgressReportId)) errors.Add("ProgressReportId is required.");
