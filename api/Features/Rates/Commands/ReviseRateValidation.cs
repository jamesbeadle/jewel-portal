...
public sealed class ReviseRateValidation
{
    public ValidationOutcome Check(ReviseRate command)
    {
        var errors = new List<string>();
        if (string.IsNullOrWhiteSpace(command.RateId)) errors.Add("RateId is required.");
