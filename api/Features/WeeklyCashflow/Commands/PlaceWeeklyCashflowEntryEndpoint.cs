...
public sealed class PlaceWeeklyCashflowEntryEndpoint
{
    ...
    private readonly ICommandHandler<PlaceWeeklyCashflowEntry, WeeklyCashflowPlacement?> handler;
    ...
    public PlaceWeeklyCashflowEntryEndpoint(
        ...
        ICommandHandler<PlaceWeeklyCashflowEntry, WeeklyCashflowPlacement?> handler)
    {
        this.users = users;
