...
public static class SalesFeatureRegistration
{
    public static IServiceCollection AddSalesFeature(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        Register<SetEstimateNarrative, LeadEstimate, SetEstimateNarrativeHandler, SetEstimateNarrativeAuthorisation, SetEstimateNarrativeValidation>(services);
        Register<SetEstimateHouseModel, LeadEstimate, SetEstimateHouseModelHandler, SetEstimateHouseModelAuthorisation, SetEstimateHouseModelValidation>(services);
