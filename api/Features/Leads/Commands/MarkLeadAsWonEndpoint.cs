...
public sealed class MarkLeadAsWonEndpoint
{
    private readonly SignedInUserResolver users;
    private readonly MarkLeadAsWonAuthorisation authorisation;
    private readonly MarkLeadAsWonValidation validation;
    private readonly ICommandHandler<MarkLeadAsWon, LeadOutcome> handler;

    public MarkLeadAsWonEndpoint(
        SignedInUserResolver users,
        MarkLeadAsWonAuthorisation authorisation,
        MarkLeadAsWonValidation validation,
        ICommandHandler<MarkLeadAsWon, LeadOutcome> handler)
    {
        this.users = users;
