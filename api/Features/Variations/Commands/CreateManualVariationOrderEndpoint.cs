...
/// Issued, its build-up staged) with no request behind it. Body: { title, lines, description?,
/// number?, commercialBasis?, programmeImpact?, exclusions? }. The creator is the signed-in user.
