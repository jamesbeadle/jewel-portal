...
/// client secret (client-credentials flow). The token is cached in-process and refreshed a few
/// minutes before expiry, so the hot path makes no token call per request.
/// </summary>
