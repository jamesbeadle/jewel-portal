...
{
    // Xero cost-code names -> master code (JBB Cost Code Master v2.1, trade-prefixed).
    // Curated from the tracking options in use.
    private static readonly Dictionary<string, string> CostCodeAliases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Excavation"] = "SUB-EXC",
        ["Hire Costs"] = "HAND-MSC",              // no plant-hire bucket in the master -> Misc
