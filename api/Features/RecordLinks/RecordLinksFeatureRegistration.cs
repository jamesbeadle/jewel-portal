...
public static class RecordLinksFeatureRegistration
{
    public static IServiceCollection AddRecordLinksFeature(this IServiceCollection services)
    {
        ...
        services.AddScoped<ILinkableRecordProvider, InventoryLinkProvider>();
        services.AddScoped<ILinkableRecordProvider, SiteInstructionLinkProvider>();
        ...
        services.AddScoped<ILinkableRecordProvider, RetiredValuationStatementLinkProvider>(); // retired type — resolves old ids and VRS tags to the claim
        services.AddScoped<ILinkableRecordProvider, ValuationClaimLinkProvider>();
        ...
        services.AddScoped<SendProgrammeReplyAuthorisation>();
        services.AddScoped<SendProgrammeReplyValidation>();
