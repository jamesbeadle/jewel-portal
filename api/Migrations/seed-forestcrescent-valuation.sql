...
BEGIN
    ...
    USING (VALUES
        ...
        (N'fc-cw-137', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'DEC-STD', N'Mist & 2 coats of Dulux emulsion to ceilings', N'm2', 124.0000, 16.0000, 1984.0000, N'', 137),
        (N'fc-cw-138', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'DEC-STD', N'Ditto walls', N'm2', 248.0000, 14.0000, 3472.0000, N'', 138),
        (N'fc-cw-139', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'CARP-2FX', N'Timber battens & vertical oak cladding', N'm2', 6.0000, 120.0000, 720.0000, N'Omit item V14', 139),
        (N'fc-cw-140', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'WDR-TIM', N'Prepare & decorate doors', N'm2', 25.0000, 30.0000, 750.0000, N'', 140),
        (N'fc-cw-141', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'DEC-STD', N'Prepare & decorate existing staircase', N'item', 1.0000, 850.0000, 850.0000, N'Omit item V26', 141),
        (N'fc-cw-142', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'CARP-2FX', N'Frames, architrave, window board & skirtings', N'm', 172.0000, 8.0000, 1376.0000, N'', 142),
        (N'fc-cw-143', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'TIL-STD', N'Fix only - Floor & wall tiles to ensuites / bathrooms', N'm2', 16.0000, 80.0000, 1280.0000, N'', 143),
        (N'fc-cw-144', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'FLR-WD', N'Reconfigure hallway flooring into reception room 1', N'item', 1.0000, 440.0000, 440.0000, N'', 144),
        (N'fc-cw-145', @ProjectId, 0, N'17', N'Decorations & finishes - To entrance hallway, reception room 1 & 2, study, ground floor wc, utility room, first floor heallway, bedrooms 1,2 & 3, new ensuite & dressing room', N'', N'', 0, N'FLR-WD', N'Sand & treat existing timber floor to reception room 1 & 2', N'm2', 32.0000, 52.0000, 1664.0000, N'', 145),
