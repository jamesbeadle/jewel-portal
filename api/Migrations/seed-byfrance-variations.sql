...
USING (VALUES
    ...
    (N'bf-vo-v06', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V06', N'Site Supervision 3 days - August 24', 0, N'PRELIMS-SMG', N'', N'item', 1.0000, 1610.0000, 1610.0000, N'', 5),
    (N'bf-vo-v07', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V07', N'Site Supervision 3 days - Sept 24', 0, N'PRELIMS-SMG', N'', N'item', 1.0000, 1360.0000, 1360.0000, N'', 6),
    (N'bf-vo-v08', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V08', N'Site Supervision 2 days - Oct 24', 0, N'PRELIMS-SMG', N'', N'item', 1.0000, 1360.0000, 1360.0000, N'', 7),
    (N'bf-vo-v09', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V09', N'Site Supervision 2 days - Nov 24', 0, N'PRELIMS-SMG', N'', N'item', 1.0000, 1360.0000, 1360.0000, N'', 8),
    (N'bf-vo-v10', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V10', N'Ground gas collection & ventilated systems - Provisional sum', 0, N'SUB-GWK', N'', N'item', 1.0000, 5116.0000, 5116.0000, N'', 9),
    (N'bf-vo-v11', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V11', N'Connection Details - Steel Fabrication', 0, N'STR-STL', N'', N'item', 1.0000, 4125.0000, 4125.0000, N'', 10),
    (N'bf-vo-v12', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V12', N'Tree Protection - STEM Arb Report', 0, N'PRELIMS-SET', N'', N'item', 1.0000, 2100.0000, 2100.0000, N'', 11),
    (N'bf-vo-v13', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V13', N'Thames Sewer Connections - MC0476 Model1-CIV10', 0, N'SUB-DRN', N'', N'item', 1.0000, 6396.0000, 6396.0000, N'', 12),
    (N'bf-vo-v14', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V14', N'Driveway Porous Stone - MC0476 Model1-CIV10', 0, N'EXTW-PAV', N'', N'item', 1.0000, 42936.0000, 42936.0000, N'', 13),
    (N'bf-vo-v15', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V15', N'Site Supervision - EOT-01', 0, N'PRELIMS-SMG', N'', N'item', 1.0000, 5860.0000, 5860.0000, N'', 14),
    (N'bf-vo-v16', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V16', N'Pond', 0, N'EXTW-LND', N'', N'item', 1.0000, 26351.0000, 26351.0000, N'', 15),
    (N'bf-vo-v17', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V17', N'100mm Ducting to the entrance gates', 0, N'EXTW-FEN', N'', N'item', 1.0000, 1720.0000, 1720.0000, N'', 16),
    (N'bf-vo-v18', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V18', N'Aluminium windows - throughout', 0, N'WDR-ALU', N'', N'item', 1.0000, 11474.1000, 11474.1000, N'', 17),
    (N'bf-vo-v19', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V19', N'Additional Drainage TBC', 4, N'MEC-DRN', N'', N'item', 1.0000, 0.0000, 0.0000, N'', 18),
    (N'bf-vo-v20', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V20', N'4 No Canopies', 2, N'SPEC-GAZ', N'', N'item', 1.0000, -22200.0000, -22200.0000, N'', 19),
    (N'bf-vo-v21', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V21', N'W-07 Rebuild Opening - PRO-064-(WD)-P-004 Rev G', 0, N'MASON-BRK', N'', N'item', 1.0000, 400.0000, 400.0000, N'', 20),
    (N'bf-vo-v22', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V22', N'SW.1 - G11 - SITE WORKS - Rev B', 0, N'EXTW-LND', N'', N'item', 1.0000, 7600.0000, 7600.0000, N'', 21),
    (N'bf-vo-v23', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V23', N'Chandelier', 0, N'ELE-STD', N'', N'item', 1.0000, 29533.0000, 29533.0000, N'', 22),
    (N'bf-vo-v24', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V24', N'Wet underfloor heating to ground floor (carers only)', 0, N'MEC-UFH', N'', N'item', 1.0000, 4093.0000, 4093.0000, N'', 23),
    (N'bf-vo-v25', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V25', N'Site Supervision - EOT-02', 0, N'PRELIMS-SMG', N'', N'item', 1.0000, 3516.0000, 3516.0000, N'', 24),
    (N'bf-vo-v26', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V26', N'Air conditioning', 0, N'MEC-AC', N'', N'item', 1.0000, 8925.0000, 8925.0000, N'', 25),
    (N'bf-vo-v27', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V27', N'Intruder Alarm', 2, N'ELE-ALM', N'', N'item', 1.0000, -6640.0000, -6640.0000, N'', 26),
    (N'bf-vo-v28', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V28', N'Fire and smoke alarm', 2, N'ELE-FIR', N'', N'item', 1.0000, -1310.0000, -1310.0000, N'', 27),
    (N'bf-vo-v29', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V29', N'Invoice 6764 - Croft Structural Engineers', 0, N'HAND-SPE', N'', N'item', 1.0000, 330.0000, 330.0000, N'', 28),
    (N'bf-vo-v30', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V30', N'10 mm render to internal blockwork walls', 0, N'INT-RDR', N'', N'item', 1.0000, 29185.0000, 29185.0000, N'', 29),
    (N'bf-vo-v31', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V31', N'Sanitary ware for Cloakroom', 2, N'SUP-SAN', N'', N'item', 1.0000, -12240.0000, -12240.0000, N'', 30),
    (N'bf-vo-v32', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V32', N'Supply of feature staircase', 2, N'STAIR-TIM', N'', N'item', 1.0000, -1665.0000, -1665.0000, N'', 31),
    (N'bf-vo-v33', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V33', N'Structural Steel Works - SL30 Rev 9 & SL40 Rev 8', 0, N'STR-STL', N'', N'item', 1.0000, 1870.0000, 1870.0000, N'', 32),
    (N'bf-vo-v34', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V34', N'Fix only - WC', 0, N'SUP-SAN', N'', N'item', 1.0000, 11965.0000, 11965.0000, N'', 33),
    (N'bf-vo-v35', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V35', N'Site Supervision - EOT-03', 0, N'PRELIMS-SMG', N'', N'item', 1.0000, 8790.0000, 8790.0000, N'', 34),
    (N'bf-vo-v36', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V36', N'Annex kitchen/Utility room', 0, N'SUP-KIT', N'', N'item', 1.0000, 17935.0000, 17935.0000, N'', 35),
    (N'bf-vo-v37', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V37', N'GF - ZZ Bathroom - On the Level Shower Former', 0, N'SUP-SAN', N'', N'item', 1.0000, 4245.0000, 4245.0000, N'', 36),
    (N'bf-vo-v38', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V38', N'New 6ft timber fencing', 0, N'EXTW-FEN', N'', N'item', 1.0000, 23650.0000, 23650.0000, N'', 37),
    (N'bf-vo-v39', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V39', N'Demolition - Removal of Fencing & Existing trees', 3, N'ENABLE-DEM', N'', N'item', 1.0000, 0.0000, 0.0000, N'', 38),
    (N'bf-vo-v40', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V40', N'Electrics - P-151 Rev P Electrical Plan FF', 0, N'ELE-STD', N'', N'item', 1.0000, 790.0000, 790.0000, N'', 39),
    (N'bf-vo-v41', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V41', N'Karndean flooring (£50/m supply)', 0, N'FLR-LVT', N'', N'item', 1.0000, 19067.0000, 19067.0000, N'', 40),
    (N'bf-vo-v42', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V42', N'Wall tiling (BASED ON 212M2 @ £80.00 / M2)', 2, N'TIL-STD', N'', N'item', 1.0000, -14577.0000, -14577.0000, N'', 41),
    (N'bf-vo-v43', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V43', N'Ceiling track hoists', 2, N'SPEC-LFT', N'', N'item', 1.0000, -19800.0000, -19800.0000, N'', 42),
    (N'bf-vo-v44', N'3490f944b29545c4b8d5a04130f42ab8', 3, N'', N'', N'V44', N'Radiators with TRVs', 0, N'MEC-PLM', N'', N'item', 1.0000, 2435.0000, 2435.0000, N'', 43),
