...
/// reads a client makes the same way, and ArchitectId its architect twin (DirectoryUserEntity.ArchitectId),
/// scoping an architect login to the projects that name their practice. Roles is the EFFECTIVE list (a directory Admin role expands to
