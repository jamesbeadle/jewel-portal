...
public static class RightToWorkForm
{
    ...
    /// <summary>
    /// The check as far as the form can say it — who, how engaged, the route and the share code. The
    /// rest is the checker's to fill in, in the office, against their own name.
    /// </summary>
        ...
        FormSubmission submission, IReadOnlyDictionary<string, string> answers, string checkerName, DateOnly today)
    {
        ...
        return new RightToWorkCheckDetails(
            typedName.Length > 0 ? typedName : submission.SubmitterName, Answer("email"), "", engagedAs,
