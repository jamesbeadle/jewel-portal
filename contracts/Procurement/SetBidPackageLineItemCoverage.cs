...
// VariationOrderId set). Passing Coverage = Unassigned (with both ids null) clears the link.
...
public sealed record SetBidPackageLineItemCoverage(
    ...
    string? VariationOrderId = null) : ICommand<IReadOnlyList<BidPackageLineItem>>;
