...
// ProjectId. Assignment is to a ROLE (required — Miscellaneous when no role owns it), optionally pinned to a named person who
// holds it — see TodoItem. CreatedByEmail is stamped from the signed-in user server-side — never
