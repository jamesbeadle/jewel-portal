...
public static class FinancePageGuides
{
    public static readonly IReadOnlyList<PageGuide> Guides = new PageGuide[]
    {
        new("/finance/allocation", "Cost allocation",
            ...
            + "Allocated, Buckets, Disputed, Ignored — with per-row Allocate, Set/Unset, Split…, "
            + "Allocate to bucket, Ignore and Dispute…, plus bulk bars, an \"Allocate all matched\" "
            + "banner, Sync from Xero, Re-check matches, search and Excel export; the Allocated tab "
            + "adds Send to cost centre…, Send to project… and Undo. Allocating every line of a "
