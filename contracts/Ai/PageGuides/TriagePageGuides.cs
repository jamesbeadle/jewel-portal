...
public static class TriagePageGuides
{
    public static readonly IReadOnlyList<PageGuide> Guides = new PageGuide[]
    {
        new("/control-centre", "Control Centre",
            ...
            + "valuation, ONE row per period (the Client pane's Valuation reports section): the "
            + "valuation claim itself — get_valuation_context or list_valuations, its "
            + "ValuationClaimId, type ValuationClaim. Since 2026-09-18 the claim IS the statement "
            + "(no separate snapshot); mail tagged to a retired snapshot still reads on its claim. "
            + "The SALES pane (2026-09-15) is the prospect side: an "
