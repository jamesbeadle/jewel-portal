...
public static class CommercialPageGuides
{
    public static readonly IReadOnlyList<PageGuide> Guides = new PageGuide[]
    {
        ...
        new("/projects/{project}/valuation", "Valuation Report",
            ...
            + "claim is a linkable record in the Control Centre (Client → Valuation claims, mail tag "
            + "JPMS/VAL-{project}-{claim number}): mail tagged to it reads back in the Correspondence "
            + "section and on every snapshot frozen from that claim; rolling over starts the next "
            + "claim with its own tag. The PDF prints the "
