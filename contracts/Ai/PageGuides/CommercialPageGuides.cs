...
public static class CommercialPageGuides
{
    public static readonly IReadOnlyList<PageGuide> Guides = new PageGuide[]
    {
        ...
        new("/projects/{project}/valuation", "Valuation Report",
            ...
            + "variation order; the Excel workbook has a Summary tab at that same level, a Detail "
            + "tab with every line under its area or variation order, and a flat Raw data tab. The toolbar's "
