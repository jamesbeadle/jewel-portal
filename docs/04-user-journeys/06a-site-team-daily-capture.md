...
> Persona slice through [Workflow 06 — Site Reporting & Progress](../03-workflows/06-site-delivery-programme-reporting.md). The site-app side of the story: capture has to be fast, touch-friendly, and tolerant of poor signal, or it won't be used.

**Actors:** P05 Site Team (primary — site manager / foreman). P10 Subcontractor (attendance). Consumer: P03 Project & Commercial Lead.
...
- Subcontractor attendance via QR scan or geofence — see [Workflow 06](../03-workflows/06-site-delivery-programme-reporting.md) open questions.
...
- Becomes a `Defect` candidate at close-out (workflow 08).
...
- `SiteReport`, `BoQLineItem`, `Subcontractor`, `Defect`, `DrawingRevision`. See [`/docs/data-models/entity-relationship.md`](../05-data-model/entities.md).
...
| 2 | P10 Subcontractor | Self check-in |
