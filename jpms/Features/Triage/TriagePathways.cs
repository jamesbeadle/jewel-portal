...
/// Sales (2026-09-15, Nigel): the prospect side — an estimate enquiry forwarded to the projects
/// mailbox is tagged to the sales lead it is about, which belongs to no project.
/// </summary>
public enum TriagePathway { Client, Subcontractor, Supplier, Sales, Internal }
...
public static class TriagePathways
{
    ...
    public const string SalesBucket = "JPMS/Sales";
    public const string InternalBucket = "JPMS/Internal";

    public static readonly TriagePathway[] All =
    {
        TriagePathway.Client, TriagePathway.Subcontractor, TriagePathway.Supplier, TriagePathway.Sales, TriagePathway.Internal
    };
    ...
    public static TriagePathway? FromBucket(string? bucket)
    {
        ...
        if (bucket.Equals(SalesBucket, StringComparison.OrdinalIgnoreCase)) return TriagePathway.Sales;
