...
public static class RequestsRouteRegistration
{
    ...
    public static void RegisterRequestsRoutes(QueryRouteTable queries, CommandRouteTable commands)
    {
        ...
        commands.Register<SendRequestEmail, RequestEmailOutcome>(
            new CommandRoute("POST", "/api/requests/{requestId}/email-draft",
                command => $"/api/requests/{((SendRequestEmail)command).RequestId}/email-draft"));
        ...
        commands.Register<SendRequestReply, RequestEmailOutcome>(
            new CommandRoute("POST", "/api/requests/{requestId}/email-draft/reply",
                command => $"/api/requests/{((SendRequestReply)command).RequestId}/email-draft/reply"));
        ...
        commands.Register<SendRequestEmails, RequestEmailBatch>(
