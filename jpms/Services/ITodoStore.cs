...
// carry a blank ProjectId.
public interface ITodoStore
{
    Task<IReadOnlyList<TodoItem>> ListForProjectAsync(string projectId, CancellationToken cancellationToken = default);
    /// <summary>Every item assigned to the signed-in user — general and project items alike.
    /// Backs the "My to-dos" dashboard panel and the browser for non-admin roles.</summary>
