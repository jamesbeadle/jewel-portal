...
public sealed class HttpXeroTrackingCategoriesStore : IXeroTrackingCategoriesStore
{
    private readonly XeroTrackingCategoriesReadModel readModel;
    ...
    public HttpXeroTrackingCategoriesStore(XeroTrackingCategoriesReadModel readModel)
    {
    ...
    public XeroTrackingCategoriesSnapshot? Snapshot()
    {
        EnsureRequested();
