...
public sealed class HttpXeroAgedReceivablesStore : IXeroAgedReceivablesStore
{
    private readonly XeroAgedReceivablesReadModel readModel;
    ...
    public HttpXeroAgedReceivablesStore(XeroAgedReceivablesReadModel readModel)
    {
    ...
    public XeroAgedReceivablesSnapshot? Snapshot()
    {
        EnsureRequested();
