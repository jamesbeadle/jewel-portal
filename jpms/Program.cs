...
builder.Services.AddFormsServices();
builder.Services.AddHsAuditReadModels();
...
builder.Services.AddSiteInstructionReadModels();
builder.Services.AddKpiReadModels();
builder.Services.AddSalesReadModels();
...
using (var routeScope = app.Services.CreateScope())
{
    ...
    HsAuditRouteRegistration.RegisterHsAuditRoutes(queryRoutes, commandRoutes);
    FormsRouteRegistration.RegisterFormsRoutes(queryRoutes, commandRoutes);
